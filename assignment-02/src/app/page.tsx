...
export default function Home() {
  return (
    <section className="max-w-full mx-auto w-1/2 rounded-xl flex justify-center items-center mt-60 hover:scale-105 transition-transform duration-300 ease-in-out filter blur-2xl delay-75 cursor-default hover:shadow-lg"
    style={{
